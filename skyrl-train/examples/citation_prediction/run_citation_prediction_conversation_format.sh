...
# The exact same script as `run_citation_prediction.sh` but with `use_conversation_multi_turn=true`
...
# bash examples/citation_prediction/run_citation_prediction_conversation_format.sh

# path for dataset (.parquet files) containing the prompts and metadata for each question
DATA_DIR="$HOME/data/citation_prediction"
PROMPT_STYLE=${PROMPT_STYLE:-"short"}   # "short" or "extended"

RUN_NAME="skyrl-citation-prediction_${PROMPT_STYLE}_4turns_maxgeneratelen_500"
