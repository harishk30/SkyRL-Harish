#!/bin/bash
# Setup script for Search-R1 data download on scratch filesystem
# Target: /scratch/gpfs/ZHUANGL/hk4638
#
# This script:
# 1. Sets up cache directories for conda and uv on scratch
# 2. Downloads the Search-R1 dataset
...
#######################################
# Step 3: Download Search-R1 dataset
#######################################
echo "=== Downloading Search-R1 dataset ==="
cd /home/hk4638/SkyRL/skyrl-train

# Download and process the dataset
uv run --isolated examples/search/searchr1_dataset.py --local_dir "${DATA_DIR}"
...
uv run --isolated examples/search/searchr1_download.py --local_dir "${DATA_DIR}"
...
# SkyRL Search-R1 cache configuration
...
echo "3. Update run_search.sh to use DATA_DIR=${DATA_DIR}"
echo "=============================================="
