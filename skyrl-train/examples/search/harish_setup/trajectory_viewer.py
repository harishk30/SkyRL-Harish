"""
Gradio Trajectory Viewer for Search-R1 eval runs.
...
def create_app(checkpoints_dir: str) -> gr.Blocks:
    ...
    with gr.Blocks(title="Search-R1 Trajectory Viewer", theme=gr.themes.Soft()) as app:
        gr.Markdown("# Search-R1 Eval Trajectory Viewer")
...
def main():
    parser = argparse.ArgumentParser(description="Search-R1 Trajectory Viewer")
    parser.add_argument(
        "--checkpoints-dir",
