...
# Token budget: m * (gen_per_turn + 300*n) + prompt < max_input_length
# Base model: gen=1024, max_input=32000 => budget=27904
# Thinking model: gen=8192, max_input=65536 => budget=57344
# Each turn: ~gen_per_turn gen + ~300*n retrieval tokens
# Set per-model (updated after arg parsing)
...
# ============================================================================
DATA_DIR="/scratch/gpfs/ZHUANGL/hk4638/data/citation_prediction_v2"
...
for m in "${M_VALUES[@]}"; do
    for n in "${N_VALUES[@]}"; do
        ...
        EXPORT_VARS="MAX_TURNS=${m},TOPK=${n},NUM_SAMPLES=${NUM_SAMPLES},PROMPT_STYLE=${PROMPT_STYLE},TEMPERATURE=${TEMPERATURE},SEED=${SEED},EMBEDDING_MODEL=${EMBEDDING_MODEL},MAX_EXAMPLES=${MAX_EXAMPLES},MODEL_NAME=${MODEL_NAME}"
